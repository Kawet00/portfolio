...
import TetrisWindow from './windows/TetrisWindow';
  ...
  return (
    ...
    >
      ...
      <div className="desktop-icons grid grid-cols-6 md:grid-cols-12 gap-4 md:gap-6 mt-4">
        ...
        <DesktopIcon id="snake" label="Snake" icon="ri-gamepad-line" />
        <DesktopIcon id="tetris" label="Tetris" icon="ri-gamepad-line" />
        <DesktopIcon id="explorer" label="Explorer" icon="ri-folder-line" />
      ...
      <Window id="snake" className="max-w-2xl">
        <SnakeWindow />
      </Window>

      <Window id="tetris" className="max-w-2xl">
        <TetrisWindow />
      </Window>

      <Window id="explorer" className="max-w-2xl">
        <FileExplorerWindow />
      </Window>
